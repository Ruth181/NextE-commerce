                    ...
                    <div className="w-100">
                        ...
                        <div className="col-sm-10 mb-3">
                            <div className="form-check">
                                <input className="form-check-input shadow-none"
                                    ...
                                    id="gridCheck1" />
                                <label
                                    className="form-check-label text-black shadow-none"
                                    htmlFor="gridCheck1">
                                    Email me
                                </label>
                            </div>
                        ...
                        <form action="">
                            ...
                            <div className="row gx-3 gy-2 align-items-center mb-3">
                                ...
                                <div className="col-12 col-sm-4">
                                    <select
                                        className="form-select rounded-2 border shadow-none shadow-none"
                                        style={{ padding: '0.8rem' }}
